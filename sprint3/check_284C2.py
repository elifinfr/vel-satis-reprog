...
# 1. sub_284C2 - called from fail path
disasm(0x284C2, 80, 'sub_284C2 (called from fail path 0x27D88)')

# 2. sub_284DE - called from fail path
disasm(0x284DE, 80, 'sub_284DE (called from fail path 0x27D88)')

# 3. sub_27E02 - final destination after fail path processing
disasm(0x27E02, 40, 'sub_27E02 (final dest after fail path)')

# 4. The AB9A4 area to check what R4/R5 are at the JSR
disasm(0xAB990, 60, 'sub_AB676 @ 0xAB9A4 write site detail')

# 5. sub_310BC - called from 0x3096A in the wait/timeout area
disasm(0x310BC, 80, 'sub_310BC (called via BSR from wait loop)')
